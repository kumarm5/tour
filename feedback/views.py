...
class FeedbackHome(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if feedback:
            ...
            html_message = 'Username: '+username+'<br>'+'Mobile No: '+mobile+'<br>'+'Message: '+message+'<br>'+html_message

            msg = EmailMessage('Feedback', html_message, 'tanishtravels24@yahoo.co.in', [],['tanishtravels24@yahoo.co.in'])
