...
class HomeView(TemplateView):
    def get(self, request, **kwargs):
        ...
        return render(request, 'home.html', context={ 'homeimagesliders': homeimagesliders, 'tour_packages': tour_packages, 'gallery_menus': gallery_menus, 'testimonial_details': testimonial_details, 'insurance_details': insurance_details, 'new_infos': new_infos })
